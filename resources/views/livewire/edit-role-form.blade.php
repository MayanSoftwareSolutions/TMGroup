                                        ...
                                        @if ($currentPage === 1)
                                            ...
                                            <div class="flex flex-col">
                                                <div class="max-w-6xl mx-auto py-6 sm:px-6 lg:px-6">
                                                    <label for="permissions" class="block font-medium text-sm text-gray-700 mb-2 ">System Permissions</label>
                                                    <div class="block mb-8">
                                                        <div class="flex flex-row flex-wrap">
                                                            ...
                                                            <label class="inline-flex bg-white hover:bg-purple-600 text-sm mt-2 mb-2 mr-2 font-semibold py-1 px-2 border border-gray-400 rounded shadow-sm">
                                                              <input type="checkbox" wire:model="selected.{{ $permission->id }}" name="permissions[]" id="permissions" value="{{ $permission->id }}" class="form-checkbox h-5 w-5 rounded-xl text-black">
